...
/**
  * Defines the MessageSinkReverse interface. The interface facilitates bi-directional message passing among objects by establishing common methods and behavior for interaction between a source of messages and one or more consumers of messages.
  * <p>
  * A MessageSinkReverse receives data as messages, defined as MessageBlocks, in the reverse direction from one or more MessageSourceReverse components to which it is attached.
  * <p>
  ...
  * @version 06-6-2017
  */
public interface MessageSinkReverse {
