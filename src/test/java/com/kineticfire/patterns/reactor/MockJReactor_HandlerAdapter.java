...
public class MockJReactor_HandlerAdapter extends JReactor {
	...
	private List<MessageBlock> commands;
   	...
   	public MockJReactor_HandlerAdapter( ) {
	}

   	public MockJReactor_HandlerAdapter( Handler criticalErrorHandler ) {
   	}
   	
   	
   	public MockJReactor_HandlerAdapter( int workerThreadNum, Handler criticalErrorHandler ) {
   	}
   	
   	
   	public MockJReactor_HandlerAdapter( int workerThreadNum, Handler criticalErrorHandler, boolean enableAllSelectors ) {
   	}
	...
	private void processDispatchFailRunning( Handler handler, Event event ) {
	}
